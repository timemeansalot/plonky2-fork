...
pub const POSEIDON_FAST_PARTIAL_SIZE: usize = 639 * std::mem::size_of::<u64>(); // 5112 bytes
pub const POSEIDON_CONST_SIZE: usize =
    POSEIDON_RC_SIZE + POSEIDON_MDS_SIZE + POSEIDON_FAST_PARTIAL_SIZE; // 8088 bytes
